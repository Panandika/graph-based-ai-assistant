...
export function Toast({ type, title, message, onDismiss }: ToastProps) {
    return (
        <div className={`${bgColors[type]} p-4 rounded shadow-lg border border-gray-200 dark:border-gray-700 flex items-start gap-3 min-w-[300px] animate-in slide-in-from-right fade-in duration-300`}>
